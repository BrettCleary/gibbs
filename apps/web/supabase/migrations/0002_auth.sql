...
--> statement-breakpoint
ALTER TABLE "app_auth"."account" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "app_auth"."session" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "app_auth"."verification" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
CREATE INDEX "ix_account_user_id" ON "app_auth"."account" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "ix_session_user_id" ON "app_auth"."session" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "ix_verification_identifier" ON "app_auth"."verification" USING btree ("identifier");